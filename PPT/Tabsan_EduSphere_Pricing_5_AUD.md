...
- Pricing confirmation: Enterprise remains AUD 5 per user yearly (no price change).

## Detailed Plan Fit: Enterprise
Summary: Enterprise is optimized for multi-campus scale, strict governance, and high-confidence institutional transformation.

...
SELECT 'DummySeed_StudyPlanFilterDemo_PlanCount' AS [CheckName], COUNT(1) AS [Value]
FROM [study_plans]
WHERE [Id] IN
(
	CAST('9A111111-1111-1111-1111-111111111101' AS UNIQUEIDENTIFIER),
	CAST('9A111111-1111-1111-1111-111111111102' AS UNIQUEIDENTIFIER),
	CAST('9A111111-1111-1111-1111-111111111103' AS UNIQUEIDENTIFIER)
)
	AND [IsDeleted] = 0;

SELECT 'DummySeed_StudyPlanFilterDemo_CourseLinkCount' AS [CheckName], COUNT(1) AS [Value]
FROM [study_plan_courses]
WHERE [StudyPlanId] IN
(
	CAST('9A111111-1111-1111-1111-111111111101' AS UNIQUEIDENTIFIER),
	CAST('9A111111-1111-1111-1111-111111111102' AS UNIQUEIDENTIFIER),
	CAST('9A111111-1111-1111-1111-111111111103' AS UNIQUEIDENTIFIER)
...
SELECT 'DummySeed_StudyPlanFilterDemo_UniversityCount' AS [CheckName], COUNT(1) AS [Value]
FROM [study_plans]
WHERE [StudentProfileId] = CAST('99999999-9999-9999-9999-999999999911' AS UNIQUEIDENTIFIER)
	AND [Id] = CAST('9A111111-1111-1111-1111-111111111101' AS UNIQUEIDENTIFIER)
	AND [IsDeleted] = 0;

SELECT 'DummySeed_StudyPlanFilterDemo_CollegeCount' AS [CheckName], COUNT(1) AS [Value]
FROM [study_plans]
WHERE [StudentProfileId] = CAST('99999999-9999-9999-9999-999999999933' AS UNIQUEIDENTIFIER)
	AND [Id] = CAST('9A111111-1111-1111-1111-111111111102' AS UNIQUEIDENTIFIER)
	AND [IsDeleted] = 0;

SELECT 'DummySeed_StudyPlanFilterDemo_SchoolCount' AS [CheckName], COUNT(1) AS [Value]
FROM [study_plans]
WHERE [StudentProfileId] = CAST('99999999-9999-9999-9999-999999999941' AS UNIQUEIDENTIFIER)
	AND [Id] = CAST('9A111111-1111-1111-1111-111111111103' AS UNIQUEIDENTIFIER)
	AND [IsDeleted] = 0;
...
(
	...
	CAST('8C8C8C8C-8C8C-8C8C-8C8C-8C8C8C8C8007' AS UNIQUEIDENTIFIER),
...
(
	...
	CAST('9A9A9A9A-9A9A-9A9A-9A9A-9A9A9A9A9904' AS UNIQUEIDENTIFIER),

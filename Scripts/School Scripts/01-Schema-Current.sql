...
/*
  School compatibility self-heal:
...
BEGIN
  ...
  IF COL_LENGTH('courses', 'InstitutionType') IS NULL
    ALTER TABLE [courses] ADD [InstitutionType] INT NOT NULL CONSTRAINT [DF_school_courses_InstitutionType] DEFAULT ((3));
  ...
  IF COL_LENGTH('course_offerings', 'InstitutionType') IS NULL
    ALTER TABLE [course_offerings] ADD [InstitutionType] INT NOT NULL CONSTRAINT [DF_school_course_offerings_InstitutionType] DEFAULT ((3));

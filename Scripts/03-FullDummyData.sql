...
BEGIN
    ...
    SELECT '10101010-1010-1010-1010-101010101010', N'DemoDatasetVersion', N'FullDummyData-v36', @Now, NULL
    ...
    SET [DemoValue] = N'FullDummyData-v36',
        [UpdatedAt] = @Now
...
BEGIN
    ...
    WHERE NOT EXISTS (SELECT 1 FROM [results] x WHERE x.[Id] = r.Id);
        ...
        BEGIN
            ...
            WHERE NOT EXISTS (SELECT 1 FROM [users] u WHERE u.[Id] = src.[Id]);

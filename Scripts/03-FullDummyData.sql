...
BEGIN
    ...
    SELECT '10101010-1010-1010-1010-101010101010', N'DemoDatasetVersion', N'FullDummyData-v35', @Now, NULL
    ...
    SET [DemoValue] = N'FullDummyData-v35',
        [UpdatedAt] = @Now
...
BEGIN
    ...
    WHERE NOT EXISTS (SELECT 1 FROM [results] x WHERE x.[Id] = r.Id);
        ...
        BEGIN
            ...
            SELECT src.[Id], src.[UserId], src.[RegistrationNumber], CAST('22222222-2222-2222-2222-222222222431' AS UNIQUEIDENTIFIER), CAST('13333333-3333-3333-3333-333333333331' AS UNIQUEIDENTIFIER),
                   CAST('2022-01-15' AS date), src.[Cgpa], 12, @Now, NULL, 0, NULL, 1, src.[CurrentSemesterGpa]
            FROM (VALUES
                (CAST('8A8A8A8A-8A8A-8A8A-8A8A-8A8A8A8A8901' AS UNIQUEIDENTIFIER), CAST('8B8B8B8B-8B8B-8B8B-8B8B-8B8B8B8B8801' AS UNIQUEIDENTIFIER), N'2026-MAT-AUD-001', CAST(3.65 AS DECIMAL(4,2)), CAST(3.80 AS DECIMAL(4,2))),
                (CAST('8A8A8A8A-8A8A-8A8A-8A8A-8A8A8A8A8902' AS UNIQUEIDENTIFIER), CAST('8B8B8B8B-8B8B-8B8B-8B8B-8B8B8B8B8802' AS UNIQUEIDENTIFIER), N'2026-MAT-AUD-002', CAST(3.10 AS DECIMAL(4,2)), CAST(3.20 AS DECIMAL(4,2))),
                (CAST('8A8A8A8A-8A8A-8A8A-8A8A-8A8A8A8A8903' AS UNIQUEIDENTIFIER), CAST('8B8B8B8B-8B8B-8B8B-8B8B-8B8B8B8B8803' AS UNIQUEIDENTIFIER), N'2026-MAT-AUD-003', CAST(2.40 AS DECIMAL(4,2)), CAST(2.50 AS DECIMAL(4,2)))
            ) src([Id], [UserId], [RegistrationNumber], [Cgpa], [CurrentSemesterGpa])
